import type { KillBehavior, TaskFunctionObject, TaskFunctionProperties } from '@poolifier/poolifier-web-worker';
...
/**
 * Indicates if running in Astro runtime.
 *
 * @internal
 */
// deno-lint-ignore no-explicit-any
const isAstro: boolean = !!(globalThis as any).Astro

/**
 * Indicates if running in Node.js runtime.
 *
 * @internal
 */
// deno-lint-ignore no-explicit-any
...
export const runtime: JavaScriptRuntimes = (() => {
  ...
  if (isAstro) return JavaScriptRuntimes.astro
